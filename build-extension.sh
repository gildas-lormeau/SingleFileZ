...
sed -i 's/7544745492-ig6uqhua0ads4jei52lervm1pqsi6hot/7544745492-oe3q2jjvdluks2st2smslmrofcdederh/g' manifest.json
zip -r singlefilez-extension-chromium.zip manifest.json lib _locales src/extension
...
zip -r singlefilez-extension-edge.zip manifest.json lib _locales src/extension
rm -rf _locales/*
