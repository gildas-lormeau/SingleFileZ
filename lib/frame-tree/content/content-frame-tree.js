...
this.singlefile.lib.frameTree.content.frames = this.singlefile.lib.frameTree.content.frames || (() => {
	...
	const INIT_REQUEST_MESSAGE = "singlefilez.frameTree.initRequest";
	const CLEANUP_REQUEST_MESSAGE = "singlefilez.frameTree.cleanupRequest";
	const INIT_RESPONSE_MESSAGE = "singlefilez.frameTree.initResponse";
	const TARGET_ORIGIN = "*";
