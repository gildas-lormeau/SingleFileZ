...
class Processor {
	...
	async getPageData() {
		...
		if (this.options.insertMetaCSP) {
			...
			metaTag.content = "default-src 'none'; font-src 'self' data: blob:; img-src 'self' data: blob:; style-src 'unsafe-inline' data: blob:; frame-src data: blob:; script-src 'unsafe-inline' data: blob:;";
