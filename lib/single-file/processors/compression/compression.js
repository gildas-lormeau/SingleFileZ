...
/* global singlefile, window, globalThis, Blob, document, zip, fetch, XMLHttpRequest, TextEncoder, DOMParser, FileReader, stop, setTimeout, clearTimeout, CustomEvent, URL, prompt, alert */

singlefile.lib.processors.compression = (globalThis => {
	...
	async function compressPage(pageData, options) {
		...
		if (browser && browser.runtime && browser.runtime.getURL) {
			zip.configure({ workerScripts: { deflate: ["lib/single-file/vendor/zip/z-worker.js"] } });
