	...
	if (globalThis.FontFace) {
		...
		globalThis.FontFace = function () {
			if (!warningFontFaceDisplayed) {
				warn("SingleFileZ is hooking the FontFace constructor to get font URLs."); // eslint-disable-line no-console
	...
	if (globalThis.IntersectionObserver) {
		...
		globalThis.IntersectionObserver = function () {
			if (!warningIntersectionObserverDisplayed) {
				warn("SingleFileZ is hooking the IntersectionObserver API to detect and load deferred images."); // eslint-disable-line no-console
