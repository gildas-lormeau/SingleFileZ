...
this.singlefile.lib.helper = this.singlefile.lib.helper || (() => {
	...
	addEventListener("single-filez-user-script-init", () => singlefile.lib.helper.waitForUserScript = async eventPrefixName => {
